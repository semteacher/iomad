...
$string['expiried'] = 'Expired';
$string['expireoptions'] = 'Expire Options';
$string['enablecertexpire'] = 'Enable certificate expiration';
$string['enablecertexpire_help'] = 'If enabled, the Certificate will have a limited duration of validity';
$string['validinterval'] = 'Valid Interval';
$string['validinterval_help'] = 'You can chose one of the following intervals: 30 days, 1 or 2 years, that certificate will be valid until';
$string['valid2monthend'] = 'Valid until end of month';
$string['valid2monthend_help'] = 'For 1- or 2-years valid certificates it are possible to provide extra term: the certificate will be valid until last day of month';
$string['expireemailnotify'] = 'Send expiry notification(s) to';
$string['expireemailnotify_help'] = 'Certificate\'s expiry notification(s) could be sent to student, teachers or both';
$string['expireemailreminde'] = 'Notification will be send ahead';
$string['expireemailreminde_help'] = 'You can chose, how many days before expiration date the notification will be sent';
$string['expireemail'] = 'Send expired warning(s) to';
$string['expireemail_help'] = 'Warning that certificate has been expired could be sent to student, teachers or both';
$string['printnexpiredate'] = 'Print Expiration Date';
$string['printnexpiredate_help'] = 'If enabled, the Certificate Expiration date will be added to certificate';
$string['valid30days'] = '30 days';
$string['valid1year'] = '1 year';
$string['valid2years'] = '2 years';
$string['teacher'] = 'Teacher only';
$string['student'] = 'Student only';
$string['teacherandstudent'] = 'Student and All Teachers';
$string['expiredin7days'] = '7 days';
$string['expiredin30days'] = '30 days';
